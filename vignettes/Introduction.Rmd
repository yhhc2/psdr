...
plot_result <- ggplot2::ggplot(subset(example_data, example_data$Category=="A"), ggplot2::aes_string(x = "Time in seconds", y = "Signal", colour = "Session", group = 1)) + ggplot2::geom_line()
